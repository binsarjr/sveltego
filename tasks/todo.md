...
### v1.0 (62 issues) — Production Ready

Benchmark suite vs adapter-bun with nightly regression gate. Docs site (Vitepress). Blog and dashboard examples. Streaming responses. Prerender / SSG mode. CSP nonce injection. CI (GitHub Actions). Release pipeline (release-please + GoReleaser). LSP for `.svelte` with Go expressions. Sitemap/robots helpers, image optimization (`<Image>`), service worker convention, deploy adapters (server, docker, static, lambda, cloudflare). SSR Option B track ([RFC #421](https://github.com/binsarjr/sveltego/issues/421) + tracking [#422](https://github.com/binsarjr/sveltego/issues/422) + 9 phase issues #423–#431) shipped 2026-05-02; original carryovers ([#435](https://github.com/binsarjr/sveltego/issues/435), [#440](https://github.com/binsarjr/sveltego/issues/440), [#443](https://github.com/binsarjr/sveltego/issues/443)) all closed. Mustache-Go atomic delete + post-merge follow-ups landed via [#486](https://github.com/binsarjr/sveltego/issues/486)/[#491](https://github.com/binsarjr/sveltego/issues/491)/[#494](https://github.com/binsarjr/sveltego/issues/494)/[#502](https://github.com/binsarjr/sveltego/issues/502). Hydration-payload spike closes [#315](https://github.com/binsarjr/sveltego/issues/315) via [#503](https://github.com/binsarjr/sveltego/issues/503); only [#492](https://github.com/binsarjr/sveltego/issues/492) (`<Image>` lowering) and a small set of perf follow-ups remain open.
