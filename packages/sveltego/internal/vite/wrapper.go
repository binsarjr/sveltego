...
// props into the store at construction so a subsequent same-route
// reactive update (e.g. invalidate, query-string change) can mutate
// the store and propagate without unmounting the layout chain.
...
func GenerateWrapper(opts WrapperOptions) string {
	...
	b.WriteString("  // without remounting (#508).\n")
